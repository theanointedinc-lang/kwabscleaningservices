...
export default function WindowCleaningPage({ onOpenBooking }) {
  return (
    <div style={{ paddingTop: '7rem', backgroundColor: '#ffffff' }}>
      ...
      {/* Service Page Banner */}
      <section style={{
        background: 'linear-gradient(135deg, rgba(20, 5, 40, 0.88) 0%, rgba(59, 7, 100, 0.85) 50%, rgba(15, 23, 42, 0.94) 100%), url("/window-cleaning-hero.jpg") center/cover no-repeat',
        color: '#ffffff',
        padding: '5rem 0',
        position: 'relative',
      }}>
